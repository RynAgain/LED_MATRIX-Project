...
FONT_5X7 = {
    ...
    # Symbols the stock ticker / scoreboards need. Without these, _draw_char
    # silently fell back to a blank space while _text_width still reserved a
    # full cell, so "+1.2%" rendered as "1.2" with mystery gaps.
